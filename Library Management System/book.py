...
while True:
    ...
    all_lended_book = restore_books_file.restore_lended_books(all_lended_book)
    ...
    if menu == "0":
        ...
        Lend_book_file.lend_books(all_books,all_lended_book)
    elif menu == "6":
        return_book_file.return_books(all_books,all_lended_book)
    else:
